...
- [timeboxed-delivery 评估](docs/timeboxed-delivery-evals.zh.md)
- [wait-discipline 评估](docs/wait-discipline-evals.zh.md)
- [batch-concurrency 评估](docs/batch-concurrency-evals.zh.md)

## 测试

- [测试计划](docs/test-plan.zh.md)
...
- `scripts/`：本地安装和验证脚本。
- `tests/`：针对 manifest、skill、文档、默认参数和脚本的单元测试。
